...
[![Develop on Okteto](https://okteto.com/develop-okteto.svg)](https://cloud.okteto.com/deploy?repository=https://github.com/btwRagdoll/Ultroid)
...
`git clone https://github.com/btwRagdoll/Ultroid.git`
...
- Fill your details in a `.env` file, as given in [`.env.sample`](https://github.com/btwRagdoll/Ultroid/blob/main/.env.sample).
...
* [![Run on Repl.it](https://replit.com/badge/github/btwRagdoll/Ultroid)](https://replit.com/@TeamUltroid/UltroidStringSession)
